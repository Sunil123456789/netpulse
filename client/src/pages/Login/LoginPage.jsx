    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ width:380, background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:16, padding:40 }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          <div style={{ width:48, height:48, margin:'0 auto 12px', background:'linear-gradient(135deg,#4f7ef5,#7c5cfc)', borderRadius:12, display:'flex', alignItems:'center', justifyContent:'center', fontSize:20, fontWeight:800, color:'#fff', fontFamily:'var(--mono)' }}>NP</div>
          <div style={{ fontSize:20, fontWeight:700 }}>NetPulse</div>
        ...
        <div style={{ marginTop:20, textAlign:'center', fontSize:11, color:'var(--text3)', fontFamily:'var(--mono)' }}>NetPulse v1.0.0 · MIT License</div>
      </div>
    </div>
  )
}
