...
const titles = { '/home':'Command Center', '/soc':'Security Operations Center', '/zabbix':'Infrastructure Monitoring', '/noc':'Network Operations Center', '/edr':'Endpoint Detection & Response', '/tickets':'Ticket Management', '/ai':'AI Assistant', '/reports':'Reports & Analytics', '/admin':'Administration' }
