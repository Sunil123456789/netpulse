...
const titles = { '/home':'Command Center', '/soc':'Security Operations Center', '/noc':'Network Operations Center', '/edr':'Endpoint Detection & Response', '/tickets':'Ticket Management', '/ai':'AI Assistant', '/reports':'Reports & Analytics', '/admin':'Administration' }
